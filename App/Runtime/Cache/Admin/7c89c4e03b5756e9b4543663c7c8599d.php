...
<head>
	...
	<link href="/discuz/Public/media/css/login.css" rel="stylesheet" type="text/css"/>
...
<body class="login">
	<!-- BEGIN LOGO -->
	<div class="logo">
		<img src="/discuz/Public/media/image/logo-big.png" alt="" /> 
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		...
		<form class="form-vertical login-form" action="index.html">
			...
			<div class="forget-password">
				...
				<p>
					no worries, click <a href="/discuz/Public/javascript:;" class="" id="forget-password">here</a>
			...
			<div class="create-account">
				<p>
					...
					<a href="/discuz/Public/javascript:;" id="register-btn" class="">Create an account</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
	...
	<script src="/discuz/Public/media/js/jquery.validate.min.js" type="text/javascript"></script>
	<!-- END PAGE LEVEL PLUGINS -->
	<!-- BEGIN PAGE LEVEL SCRIPTS -->
	<script src="/discuz/Public/media/js/app.js" type="text/javascript"></script>
	<script src="/discuz/Public/media/js/login.js" type="text/javascript"></script>      
