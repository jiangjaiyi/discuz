					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form method="post" action="/discuz/index.php/Admin/Member/insert" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="member_name" class="span6 m-wrap popovers" placeholder="请输入用户名" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="password" name="member_pass" class="span6 m-wrap popovers" placeholder="请输入密码" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="member_age" class="span6 m-wrap popovers" placeholder="请输入年龄" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="radio" name="member_sex" value="0" checked />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<div class="input-prepend"><span class="add-on">@</span><input class="m-wrap " type="text" name="member_email" placeholder="请输入邮箱" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="radio" name="member_sectioner" value="0" checked />
											...
											<input type="radio" name="member_sectioner" value="1" />
										...
										<div class="controls">
											...
											<input type="radio" name="member_state" value="0" checked />
											...
											<input type="radio" name="member_state" value="1" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="member_address" class="span6 m-wrap popovers"placeholder="请输入地址" />
