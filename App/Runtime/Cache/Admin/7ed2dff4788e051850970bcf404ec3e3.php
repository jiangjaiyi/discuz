					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form method="post" action="/discuz/index.php/Admin/Notice/insert" class="form-horizontal" >
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<textarea name="notice_content" class="large m-wrap" rows="4" placeholder="请输入公告内容"></textarea>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" name="notice_author" class="span6 m-wrap popovers" placeholder="请输入发布者" />
