						...
						<div class="portlet box grey">
							...
							<div class="portlet-title">
								...
								<div class="actions">
									...
									<a href="/discuz/index.php/Admin/News/add" class="btn blue"><i class="icon-pencil"></i> Add</a>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_2">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-480">发帖用户id</th>

											<th class="hidden-480">版块id</th>

											<th class="hidden-480">帖子主题</th>

											<th class="hidden-480">帖子内容</th>

											<th class="hidden-480">发帖时间</th>
									...
									<tbody>
										<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="odd gradeX">
											...
											<td><?php echo ($vo["news_uid"]); ?></td>

											<td><?php echo ($vo["news_tid"]); ?></td>
											<td><?php echo ($vo["news_title"]); ?></td>
											<td><?php echo ($vo["news_content"]); ?></td>
